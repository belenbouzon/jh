package com.belen.colorima.web.rest;

import com.belen.colorima.ColorimaApp;
import com.belen.colorima.config.audit.AuditEventConverter;
import com.belen.colorima.domain.PersistentAuditEvent;
import com.belen.colorima.repository.PersistenceAuditEventRepository;
import com.belen.colorima.service.AuditEventService;
...
@SpringApplicationConfiguration(classes = ColorimaApp.class)
@WebAppConfiguration
@IntegrationTest
@Transactional
