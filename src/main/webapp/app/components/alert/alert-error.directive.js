(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('colorimaApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-colorimaApp-error');
                var entityKey = httpResponse.headers('X-colorimaApp-params');
                if (errorHeader) {
